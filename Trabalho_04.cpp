...
main(){
    ...
    bool validateHoraInicial = true;
    if(*horaIn > 24 || *minutoIn > 60 ||*segundoIn > 60 || *horaIn < 0 || *minutoIn < 0 ||*segundoIn < 0 || strlen(hora)>8){
        cout<<"\n===Valor Horario Inicial Invalido!==="<<endl;
        validateHoraInicial=false;
    }
    ...
    if(*horaFi > 24 || *minutoFi > 60 ||*segundoFi > 60 || *horaFi < 0 || *minutoFi < 0 ||*segundoFi < 0 || strlen(horaF)>8){
        cout<<"\n===Valor Horario Final Invalido!==="<<endl;
        validateHoraFinal=false;
    }

    if(validate && validateHoraInicial && validateHoraFinal){
