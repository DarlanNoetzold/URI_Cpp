 ...
 int jogar(){
     ...
     while(contador != fim){
       ...
       if(campo[lin-1][col-1]==1){
           ...
           campochar[lin-1][col-1] = '1';fim++;}
           else  if(campo1[lin-1][col-1]== 2){
           campochar[lin-1][col-1] = '2';fim++;}
           else  if(campo1[lin-1][col-1]== 3){
           campochar[lin-1][col-1] = '3';fim++;}
           else  if(campo1[lin-1][col-1]== 4){
           campochar[lin-1][col-1] = '4';fim++;}
           else  if(campo1[lin-1][col-1]== 5){
           campochar[lin-1][col-1] = '5';fim++;}
           else  if(campo1[lin-1][col-1]== 6){
           campochar[lin-1][col-1] = '6';fim++;}
           else  if(campo1[lin-1][col-1]== 7){
           campochar[lin-1][col-1] = '7';fim++;}
           else if(campo1[lin-1][col-1]== 8){
           campochar[lin-1][col-1] = '8';fim++;}
